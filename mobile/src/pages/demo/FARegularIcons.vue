...
const iconKeys = Object.keys(faRegulars);
...
<template>
    <Page actionBarHidden="false">
        <ActionBar>
            <Label text="FA Regular Icons" class="font-bold text-lg text-white" />
        </ActionBar>
            ...
            <FlexboxLayout flexDirection="column" class="p-4 ">
                ...
                <WrapLayout>
                    <FlexboxLayout flexDirection="column" v-for="(key, index) in   icons" :key="index"
                        ...
                        <label :text="fontIcon(key)" class="far text-shark-900 text-3xl pt-4"></label>
