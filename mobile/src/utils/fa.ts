...
export function far(icon: string) {
  return String.fromCharCode(parseInt(faRegulars[icon], 16));
}
export function fas(icon: string) {
  return String.fromCharCode(parseInt(faSolids[icon], 16));
}
export function fab(icon: string) {
  return String.fromCharCode(parseInt(faBrands[icon], 16));
}
